...
if platform.system() =='cli':
    base_path = os.path.join(os.path.dirname(__file__), 'lib',  'Linux', version)
    file_extension = '.dll'
elif platform.system() =='Windows':
    base_path = os.path.join(os.path.dirname(__file__), 'lib', 'Windows', version)
    file_extension = '.dll'
elif platform.system() == 'Darwin':
    base_path = os.path.join(os.path.dirname(__file__), 'lib', 'Mac')
    file_extension = '.dylib'
else:
    base_path = os.path.join(os.path.dirname(__file__), 'lib',  'Linux', version)
    file_extension = '.so'
libfullpath = os.path.join(base_path, 'remoteApi' + file_extension)
print('libfullpath =', libfullpath)
try:
